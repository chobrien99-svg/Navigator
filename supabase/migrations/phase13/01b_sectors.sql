...
WITH source AS (
  SELECT * FROM json_populate_recordset(
    NULL::record,
    $json$[{"name": "AgriTech"}, {"name": "Artificial Intelligence"}, {"name": "BioTech"}, {"name": "CleanTech"}, {"name": "ClimateTech"}, {"name": "Cybersecurity"}, {"name": "DeepTech"}, {"name": "DefenseTech"}, {"name": "Drones"}, {"name": "E-commerce & Retail"}, {"name": "EdTech"}, {"name": "Energy"}, {"name": "Entertainment"}, {"name": "FinTech"}, {"name": "FoodTech"}, {"name": "Gaming"}, {"name": "Hardware"}, {"name": "HealthTech"}, {"name": "InsurTech"}, {"name": "LegalTech"}, {"name": "MarTech"}, {"name": "MedTech"}, {"name": "Mobility"}, {"name": "PropTech"}, {"name": "Recycling"}, {"name": "Robotics"}, {"name": "SaaS"}, {"name": "SpaceTech & Aerospace"}, {"name": "SportsTech"}, {"name": "TravelTech"}, {"name": "Web3"}]$json$
  ) AS (name TEXT)
)
